(function() {
	...
	bh.ui.createBountyTableView = function(/*Boolean*/ _captured) {
		...
		function populateData() {
			...
			var results = [
				{title:'Jeff Haynie', hasChild:true, captured:_captured},
				{title:'Nolan Wright', hasChild:true, captured:_captured},
				{title:'Marshall Culpepper', hasChild:true, captured:_captured},
				{title:'Don Thorp', hasChild:true, captured:_captured},
				{title:'Blain Hamon', hasChild:true, captured:_captured}
			];
