...
// in simulator we redefine to format for k215 Developer console
...
{\
	NSString * exceptionName = [@"org.k215." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.k215";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIk215NativeItemNone = -1, 
	UIk215NativeItemSpinner = -2,
	UIk215NativeItemProgressBar = -3,
	
	UIk215NativeItemSlider = -4,
	UIk215NativeItemSwitch = -5,
	UIk215NativeItemMultiButton = -6,
	UIk215NativeItemSegmented = -7,
	
	UIk215NativeItemTextView = -8,
	UIk215NativeItemTextField = -9,
	UIk215NativeItemSearchBar = -10,
	
	UIk215NativeItemPicker = -11,
	UIk215NativeItemDatePicker = -12,
	
	UIk215NativeItemInfoLight = -13,
	UIk215NativeItemInfoDark = -14,
	
	UIk215NativeItemDisclosure = -15,
	
	UIk215NativeItemContactAdd = -16
};
