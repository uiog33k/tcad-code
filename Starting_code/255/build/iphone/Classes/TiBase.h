...
// in simulator we redefine to format for k255 Developer console
...
{\
	NSString * exceptionName = [@"org.k255." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.k255";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIk255NativeItemNone = -1, 
	UIk255NativeItemSpinner = -2,
	UIk255NativeItemProgressBar = -3,
	
	UIk255NativeItemSlider = -4,
	UIk255NativeItemSwitch = -5,
	UIk255NativeItemMultiButton = -6,
	UIk255NativeItemSegmented = -7,
	
	UIk255NativeItemTextView = -8,
	UIk255NativeItemTextField = -9,
	UIk255NativeItemSearchBar = -10,
	
	UIk255NativeItemPicker = -11,
	UIk255NativeItemDatePicker = -12,
	
	UIk255NativeItemInfoLight = -13,
	UIk255NativeItemInfoDark = -14,
	
	UIk255NativeItemDisclosure = -15,
	
	UIk255NativeItemContactAdd = -16
};
