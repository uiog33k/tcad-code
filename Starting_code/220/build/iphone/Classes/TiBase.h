...
// in simulator we redefine to format for k220 Developer console
...
{\
	NSString * exceptionName = [@"org.k220." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.k220";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIk220NativeItemNone = -1, 
	UIk220NativeItemSpinner = -2,
	UIk220NativeItemProgressBar = -3,
	
	UIk220NativeItemSlider = -4,
	UIk220NativeItemSwitch = -5,
	UIk220NativeItemMultiButton = -6,
	UIk220NativeItemSegmented = -7,
	
	UIk220NativeItemTextView = -8,
	UIk220NativeItemTextField = -9,
	UIk220NativeItemSearchBar = -10,
	
	UIk220NativeItemPicker = -11,
	UIk220NativeItemDatePicker = -12,
	
	UIk220NativeItemInfoLight = -13,
	UIk220NativeItemInfoDark = -14,
	
	UIk220NativeItemDisclosure = -15,
	
	UIk220NativeItemContactAdd = -16
};
