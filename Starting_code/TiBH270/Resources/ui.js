			...
			captureButton.addEventListener('click', function() {
				if (Ti.Geolocation.locationServicesEnabled) {
					...
					Ti.Geolocation.getCurrentPosition(function(e) {
						...
						/*
						should wrap the rest of the handler in something like:
						if(!e.error) {
							// on Android emulator w/out location set, the rest of this handler
							// will fail with e.coord undefined error
							...
						}
						*/
