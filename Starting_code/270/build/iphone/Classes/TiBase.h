...
// in simulator we redefine to format for k270 Developer console
...
{\
	NSString * exceptionName = [@"org.k270." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.k270";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIk270NativeItemNone = -1, 
	UIk270NativeItemSpinner = -2,
	UIk270NativeItemProgressBar = -3,
	
	UIk270NativeItemSlider = -4,
	UIk270NativeItemSwitch = -5,
	UIk270NativeItemMultiButton = -6,
	UIk270NativeItemSegmented = -7,
	
	UIk270NativeItemTextView = -8,
	UIk270NativeItemTextField = -9,
	UIk270NativeItemSearchBar = -10,
	
	UIk270NativeItemPicker = -11,
	UIk270NativeItemDatePicker = -12,
	
	UIk270NativeItemInfoLight = -13,
	UIk270NativeItemInfoDark = -14,
	
	UIk270NativeItemDisclosure = -15,
	
	UIk270NativeItemContactAdd = -16
};
