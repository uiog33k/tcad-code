...
// in simulator we redefine to format for k250 Developer console
...
{\
	NSString * exceptionName = [@"org.k250." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.k250";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIk250NativeItemNone = -1, 
	UIk250NativeItemSpinner = -2,
	UIk250NativeItemProgressBar = -3,
	
	UIk250NativeItemSlider = -4,
	UIk250NativeItemSwitch = -5,
	UIk250NativeItemMultiButton = -6,
	UIk250NativeItemSegmented = -7,
	
	UIk250NativeItemTextView = -8,
	UIk250NativeItemTextField = -9,
	UIk250NativeItemSearchBar = -10,
	
	UIk250NativeItemPicker = -11,
	UIk250NativeItemDatePicker = -12,
	
	UIk250NativeItemInfoLight = -13,
	UIk250NativeItemInfoDark = -14,
	
	UIk250NativeItemDisclosure = -15,
	
	UIk250NativeItemContactAdd = -16
};
