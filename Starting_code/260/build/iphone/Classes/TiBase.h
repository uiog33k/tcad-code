...
// in simulator we redefine to format for k260 Developer console
...
{\
	NSString * exceptionName = [@"org.k260." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.k260";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIk260NativeItemNone = -1, 
	UIk260NativeItemSpinner = -2,
	UIk260NativeItemProgressBar = -3,
	
	UIk260NativeItemSlider = -4,
	UIk260NativeItemSwitch = -5,
	UIk260NativeItemMultiButton = -6,
	UIk260NativeItemSegmented = -7,
	
	UIk260NativeItemTextView = -8,
	UIk260NativeItemTextField = -9,
	UIk260NativeItemSearchBar = -10,
	
	UIk260NativeItemPicker = -11,
	UIk260NativeItemDatePicker = -12,
	
	UIk260NativeItemInfoLight = -13,
	UIk260NativeItemInfoDark = -14,
	
	UIk260NativeItemDisclosure = -15,
	
	UIk260NativeItemContactAdd = -16
};
